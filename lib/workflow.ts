...
export function decide(stage: Stage, project: Project, actorId: string, role: Role, action: "APPROVE" | "RETURN", note?: string): Stage {
  ...
  stage.decisions.push({ id: id(), actorId, role, decision: stage.state === "CLIENT" ? "PAYMENT_RELEASED" : "APPROVED", createdAt: now, note }); stage.state = nextState; return stage;
}
