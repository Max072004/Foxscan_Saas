...
const empty = (): AppData => ({ tenants: [], users: [], sessions: [], invitations: [], buildings: [], boqItems: [], projects: [], activities: [], stages: [], invoices: [], payments: [], deviceRegistrations: [], dlpCases: [], warranties: [], disputes: [], notifications: [], siteUpdates: [], delays: [], documents: [], audits: [] });
