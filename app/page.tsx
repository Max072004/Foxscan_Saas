    ...
    return (
      <div className="app-layout">
        <div className="app-main" style={{ marginLeft: 0 }}>
          <div className="app-content">
            <div style={{ display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", minHeight: "60vh", gap: "var(--sp-4)" }}>
              <div style={{ width: 48, height: 48, borderRadius: "var(--radius-lg)", background: "var(--brand-yellow)", display: "flex", alignItems: "center", justifyContent: "center" }}>
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="var(--brand-charcoal)" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round">
